...
describe Refine::Filter do
  ...
  describe "condition with wrong id" do
    it "adds error" do
      ...
      query.conditions = [Refine::Conditions::TextCondition.new("text_field_value")]
      query.get_query
    ...
    it "get_query! raises exception" do
      ...
      filter.conditions = [Refine::Conditions::TextCondition.new("text_field_value")]
  ...
  describe "Configuration object - data going to frontend" do
    ...
    describe "Text Condition with meta, no clauses" do
      it "returns correct json" do
        filter = TestDoubleFilter.new([])
        filter.conditions =
          [Refine::Conditions::TextCondition.new("text_field_value").with_meta({hint: "password"})]
        expected_value =
          {
            type: "Refine",
            class_name: "TestDoubleFilter",
