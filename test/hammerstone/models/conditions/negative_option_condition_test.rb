...
module Hammerstone::Refine::Conditions
  ...
  class Contact < ActiveRecord::Base
    has_many :applied_tags, class_name: "Hammerstone::Refine::Conditions::Contact::AppliedTag", dependent: :destroy
    has_many :tags, through: :applied_tags
  end

  class Contact::AppliedTag < ActiveRecord::Base
    belongs_to :contact, touch: true
    belongs_to :tag, class_name: "Hammerstone::Refine::Conditions::Contact::Tag"
